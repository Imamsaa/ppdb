		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-4 mb-4 mb-md-0">
					<h2 class="footer-heading">PPDB Al Firdaus Purwodadi</h2>
					<p>Penerimaan Peserta Didik Baru LPIT Al Firdaus purwodadi</p>
				...
				<div class="col-md-6 col-lg-4 mb-4 mb-md-0">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon fa fa-map"></span><span class="text">Jalan Taman Makam Pahlawan No 19
									Purwodadi</span></li>
							<li><a href="#"><span class="icon fa fa-phone"></span><span
										class="text">+6281548811047</span></a></li>
							<li><a href="#"><span class="icon fa fa-paper-plane"></span><span
										class="text">binainsanigrobogan@gmail.com</span></a></li>
						</ul>
					</div>
				</div>
			</div>
